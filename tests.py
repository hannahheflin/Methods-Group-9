...
# tests for openFile
@pytest.mark.parametrize("filename, output", [("dne.txt", "File does not exist."), (101, "Invalid file."), ("testing.txt", "File opened.")])
...
# tests for dist
#TODO: gotta think of 1 more way to make dist() crash
...
#FIXME: apparently having just an escape character doesn't cause a crash so we would need to think of a new thing that cause the function to crash
@pytest.mark.parametrize("temp, value", [(101, "Invalid input"), ("escape\character", "String cannot contain an escape character"), ("racecar", True), ("racecar\n", False)])
...
# tests for sq
@pytest.mark.parametrize("num, result", [("five thousand", "Invalid input"), (-4, "Input cannot be negative"), (4.84, 2.2)])
